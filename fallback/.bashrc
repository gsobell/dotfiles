...
alias nvim='vim'
alias gvim='exec konsole -e vim & disown & exit'
alias packages="pacman -Qet | awk '{print $1}' > 'Packages $(date +%F).txt'"
alias present='xfconf-query -c xfce4-power-manager -p /xfce4-power-manager/presentation-mode -T&& echo "Present mode is:" && xfconf-query -c xfce4-power-manager -p /xfce4-power-manager/presentation-mode -v'
alias :q='exit'
